...
const BARRIER_LABELS: Record<string, string> = {
  ...
  third_party: "названа на чужой странице",
  site_not_found: "сайт не найден",
  site_closed: "сайт закрыт от чтения",
};
...
const BARRIER_HELP: Record<string, string> = {
  ...
  site_closed:
    "Собственный сайт компании найден — он в источнике карточки, — но " +
    "нашему чтению закрыт: сервер отвечает отказом клиенту без браузера. " +
    "Обходить отказ мы не будем, это прямо запрещено решением по доступу " +
    "к чужим площадкам. Откройте источник в браузере: почта и телефон " +
    "там обычно опубликованы прямо на странице контактов.",
  site_not_found:
    "Компанию назвала площадка, и мы искали её собственный сайт по " +
    "названию — среди найденных страниц ни одна ей не принадлежит. " +
    "Совпадения имени в заголовке чужой страницы недостаточно: так " +
    "выглядят каталоги и агрегаторы, и письмо ушло бы их владельцу. " +
    "Повторно поиск сайта не запускается; найдите компанию вручную или " +
    "напишите ей через площадку.",
  third_party:
    "Компанию мы нашли не на её сайте, а на чужой странице — в справочнике, " +
    "обзоре рынка, перечне площадки или статье. Название оттуда взяли, а " +
    "почту не берём: на такой странице она принадлежит владельцу сайта, а " +
    "не компании, и письмо ушло бы постороннему. Роль и страна там указаны " +
    "с чужих слов. Откройте источник в карточке, найдите сайт компании и " +
    "впишите контакт вручную.",
};
