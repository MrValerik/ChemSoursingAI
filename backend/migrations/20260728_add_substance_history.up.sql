...
CREATE INDEX IF NOT EXISTS ix_substance_revisions_substance_id
    ON substance_revisions (substance_id);
CREATE INDEX IF NOT EXISTS ix_substance_revisions_action
    ON substance_revisions (action);
CREATE INDEX IF NOT EXISTS ix_substance_revisions_actor_id
    ON substance_revisions (actor_id);
CREATE INDEX IF NOT EXISTS ix_substance_revisions_source_rfq_id
