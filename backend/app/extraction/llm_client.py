...
_SYSTEM_PROMPT = (
    ...
    "Не придумывай значения. Не вычисляй общую стоимость, доставку, пошлину, НДС "
    "или итоговую себестоимость: заполняй их только когда сумма прямо названа "
    "поставщиком в исходном тексте."
)
