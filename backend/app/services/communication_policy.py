...
Разреши auto_reply только если всё сообщение относится к обычному RFQ:
идентичность вещества, CAS, грейд, чистота, спецификация, образец, количество,
цена, валюта, MOQ, наличие, упаковка, документы CoA/TDS/SDS, Incoterm, доставка,
срок, условия оплаты или уточнение уже запрошенных коммерческих условий.
